...
{
	/// <summary>
	/// This controller is for example register form data validation.
	/// </summary>
	public class RegisterController : Controller
	{
		private ValidationService _validationService;

		public RegisterController(ValidationService validationService)
		{
		...
		public async Task<IActionResult> Register(RegisterViewModel model)
		{
			...
			if (!isLoginUnique)
			{
				ModelState.AddModelError("Login", "Login is alraedy taken.");
				return View(model);
			}
