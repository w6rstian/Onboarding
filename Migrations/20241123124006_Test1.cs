        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rewards_Users_Giver",
                        column: x => x.Giver,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Rewards_Users_Receiver",
                        column: x => x.Receiver,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Completed = table.Column<string>(type: "nvarchar(1)", nullable: false),
                    TaskId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseTasks_UserCourses_UserCourseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseTasks_UserCourseId",
                table: "CourseTasks",
                column: "UserCourseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rewards_Giver",
                table: "Rewards",
                column: "Giver");

            migrationBuilder.CreateIndex(
                name: "IX_Rewards_Receiver",
                table: "Rewards",
                column: "Receiver");
